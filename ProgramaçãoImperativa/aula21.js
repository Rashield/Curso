...
let listaAlunos = [];
listaAlunos.push(new Aluno("Kelvin", "M", "20", [8,7,7], 2));
listaAlunos.push(new Aluno("Fulano", "M", "25", [8,7,9], 5));
listaAlunos.push(new Aluno("beutrano", "M", "26", [8,7,8], 3));
listaAlunos.push(new Aluno("beutrano", "F", "22", [10,7,5], 3));
listaAlunos.push(new Aluno("beutrano", "F", "20", [2.5,7,6], 3));
